...
)  # Ensure you have the model class imported
...
class ModelTester:
    ...
    def iterate_and_predict(self, test_data_dirs):
        ...
        """
        preprocessor = ImageHandler(self.save_dir)
        ...
        for test_data_dir in test_data_dirs:
            ...
            test_images, _ = preprocessor.preprocess_martian_data(
                data_dir=test_data_dir, combine_images=False
            )
            ...
            for batch in test_loader:
                ...
                with torch.no_grad():
                    ...
                    arrival_time_predictions.extend(
                ...
                rows.append(
                    {
                        "folder": folder,
                        "file_index": i,
                        "predicted_arrival_time(s)": arrival_time,
                    }
                )
