...
def evaluate_and_get_metrics(trainer, test_loader, scaler, reference_time):
    """
    Evaluate the model and compute metrics like MSE, MAE, and R-squared on the test set.
    """
    trainer.evaluate(test_loader, scaler, reference_time)
...
def main():
    ...
    trainer.evaluate(lunar_test_loader, scaler, reference_time)
    ...
    evaluate_and_get_metrics(trainer, lunar_test_loader, scaler, reference_time)
